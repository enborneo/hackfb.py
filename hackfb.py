...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6282113555111&text=assalamualaikum EN')
...
if sandi == 'belajarnakal' and user == 'Borneo':
...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mSILAHKAN LOGIN AKUN FACEBOOK \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open http://enborneo.xyz/')
                time.sleep(2)
                menu()
...
def mini():
    ...
    try:
        ...
        print logo
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[ INFO ] Akun target harus berteman dengan akun anda lebih dahulu !'
        try:
